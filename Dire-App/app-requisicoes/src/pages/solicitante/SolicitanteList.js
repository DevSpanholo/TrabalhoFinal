...
const SolicitanteList = (props) => {
  ...
  return (
    <div className="App">
      <h4 className='name-solicitante'>Listagem de Solicitantes</h4>
      ...
      <DataTable value={props.solicitantes} responsiveLayout="scroll" header={header} footer={footer}
        ...
        selectionMode="single" selection={props.solicitante} onSelectionChange={e => props.seSolicitante(e.value)} dataKey="_id"
      >
